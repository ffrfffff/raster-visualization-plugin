...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        self.show_tile_labels_cb = QCheckBox("Tile Coords")
        self.show_tile_labels_cb.setChecked(True)
        self.show_pixel_coords_cb = QCheckBox("Pixel Coords")
        ...
        options_layout.addWidget(QLabel("|"))
        options_layout.addWidget(self.show_grid3d_cb)
        options_layout.addWidget(self.show_axes3d_cb)
